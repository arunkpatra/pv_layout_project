    ...
    <div className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-lg leading-relaxed text-muted-foreground">
          ...
          <li>
            <strong>Mobile number</strong> (optional) — if provided for
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-lg leading-relaxed text-muted-foreground">
          ...
          <li>
            Improving our products, features, and user experience
          </li>
          <li>
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          Your personal data is encrypted at rest and in transit. Our
          servers are located in India. We implement industry-standard
          security measures to protect your data against unauthorised
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          ...
          active, plus an additional two years after account closure or
          inactivity. After this period, your data will be securely deleted
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6 text-lg leading-relaxed text-muted-foreground">
          ...
          <li>
            <strong>Right to Grievance Redressal</strong> — raise a
            complaint with our Grievance Officer or the Data Protection
            Board of India
          </li>
        </ul>
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          ...
          essential third-party service providers (such as hosting,
          analytics, and payment processing) only to the extent necessary to
          operate the Service. All third-party providers are contractually
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          ...
          our website. Cookies are placed only after you provide consent.
        ...
        <ul className="mt-3 list-none space-y-2 pl-0 text-lg leading-relaxed text-muted-foreground">
          ...
          <li>
            <strong>Email:</strong>{" "}
            <a
              href="mailto:privacy@solarlayout.in"
              className="text-primary underline underline-offset-4 hover:text-primary/80"
            >
              privacy@solarlayout.in
            </a>
          </li>
        </ul>
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
