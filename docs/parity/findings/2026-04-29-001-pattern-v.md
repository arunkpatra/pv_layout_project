...
**Date:** 2026-04-29
**Sync run:** new project commit `58c20e6` vs legacy branch `baseline-v1-20260429` (HEAD `397aa2a` at capture; cable functions originate in commit `9362083` within this history)
**Status:** triaged
