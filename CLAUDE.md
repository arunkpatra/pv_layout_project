...
**If the commit touches build infrastructure** (package.json exports, tsconfig paths, turbo pipeline, build config, new workspace packages), gate against a clean environment instead — see [Development Principles](./docs/claude-dev-principles.md) for the clean-build command and the rationale.
