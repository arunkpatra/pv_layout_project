...
14. **Refund semantics.** If a user cancels a job mid-flight, do we refund the calc? Existing pattern (per B18 / V2-plan §2): "Run delete does NOT refund the calc". Apply same: cancelling a job after submission charges the user the full calc. Document this in the cancel-confirm dialog.
