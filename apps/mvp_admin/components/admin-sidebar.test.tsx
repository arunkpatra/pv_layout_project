...
vi.mock("@solarlayout/ui/components/sidebar", () => ({
...
vi.mock("@solarlayout/ui/components/avatar", () => ({
...
vi.mock("@solarlayout/ui/components/dropdown-menu", () => ({
...
vi.mock("@solarlayout/ui/components/badge", () => ({
  Badge: ({ children }: { children: React.ReactNode }) => (
    <span data-testid="badge">{children}</span>
  ),
}))

vi.mock("@solarlayout/ui/components/skeleton", () => ({
